...
function GM:OnSpawnMenuOpen( )
	if tobool(gms_CheckSettings("OldStrandedMenu")) ==  true then 
...
function GM:OnSpawnMenuClose( )
	if tobool(gms_CheckSettings("OldStrandedMenu")) ==  true then
		...
		self.BaseClass:OnSpawnMenuClose()
	end
end

function ToggleStrandedMenu()
	if tobool(gms_CheckSettings("OldStrandedMenu")) ==  true then
		gms_SetSetting("OldStrandedMenu",false)
		AddNotification("New Menu is active!","0,0,255")
	else
		gms_SetSetting("OldStrandedMenu",true)
		AddNotification("Old Menu is active!","0,0,255")
	end
end
concommand.Add("gms_qmenu",ToggleStrandedMenu)
