...
function ENT:Initialize()
	...
	self.Entity:SetMaterial("models/balloon/balloon_nips")
	self.Entity:SetColor(255,255,0,255)
 	self.Entity:PhysicsInit( SOLID_VPHYSICS )
	self.Entity:SetMoveType( MOVETYPE_VPHYSICS )
	self.Entity:SetSolid( SOLID_VPHYSICS )
	self.Entity.time = 0
	self.Entity.Activated = 0
end

function ENT:Use(ply)
	if self.Entity.Activated == 0 then
		UnlockAchievment(self.Entity,"Time_Waster")
		if AWOLAchievments then
			AWOLAchievments.Unlock(ply,"STR_MAKETIMEWASTER")
		end
	end
end
