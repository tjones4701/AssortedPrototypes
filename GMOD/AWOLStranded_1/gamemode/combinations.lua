...
COMBI.Description = [[This Copper table has various fine specialized equipment
...
COMBI.Description = [[This iron table has various fine specialized equipment
...
another, such as Copper Ore into Copper.
You need:
35 Stone
]]
...
COMBI.Description = [[You can use the furnace to smelt resources into 
another, such as Iron Ore into Iron.
You need:
35 Copper
]]
...
COMBI.Description = [[You can use the furnace to smelt advanced resources like diamond.
You need:
100 Steel
]]
...
GMS.RegisterCombi("SteelFurnace",COMBI,"Buildings")
...
GMS.RegisterCombi("AllSmeltSteel",COMBI,"IronFurnace")
/*---------------------------------------------------------
  Charcoal
---------------------------------------------------------*/
local COMBI = {}
...
COMBI.Name = "1x Refined Diamond"
COMBI.Description = [[Smelts 100 Diamond into 1 Refined Diamond
You need:
Diamond Ore 100
CAREFULL WHEN SMELTING TO MUCH
]]
...
COMBI.Req = {}
COMBI.Req["Diamond"] = 100

COMBI.Results = {}
COMBI.Results["Refined_Diamond"] = 1


GMS.RegisterCombi("Diamond1",COMBI,"SteelFurnace")
...
COMBI.Name = "Refined Diamond"
COMBI.Description = [[Smelts 500 Diamond into 5 Refined Diamond
You need:
Diamond Ore 500
CAREFULL WHEN SMELTING TO MUCH
]]
...
COMBI.Req = {}
COMBI.Req["Diamond"] = 500

COMBI.Results = {}
COMBI.Results["Refined_Diamond"] = 5


GMS.RegisterCombi("Diamond5",COMBI,"SteelFurnace")
...
COMBI.Name = "Squish Leaves"
COMBI.Description = [[Squish leaves to get water out of them.
You need:
5 Leaves per 1 waterbottle (100 leaves max)
]]
...
GMS.RegisterCombi("Water_Leaves",COMBI,"GrindingStone")
...
COMBI.Description = [[This Steel axe is perfect for chooping trees.
You need:
50 Steel
10 Wood
]]
...
GMS.RegisterCombi("Steel_Hatchet",COMBI,"AdvancedWeapons")
...
COMBI.Description = [[This Diamond axe is perfect for chooping trees.
You need:
50 Diamond
10 Wood
]]
...
COMBI.Texture = "weapons/swep"
COMBI.SwepClass = "gms_steelbow"

GMS.RegisterCombi("Steel_Bow",COMBI,"AdvancedWeapons")
...
COMBI.Texture = "weapons/swep"
COMBI.SwepClass = "gms_steelsword"

GMS.RegisterCombi("Steel_Sword",COMBI,"AdvancedWeapons")
...
COMBI.Description = [[This copper pickaxe is used for effectively mining 
stone, copper ore and iron ore.
You need:
15 Copper
5 Wood
]]
...
COMBI.Description = [[This iron pickaxe is used for effectively mining 
stone, copper ore and iron ore.
You need:
25 Iron
5 Wood
...
COMBI.Description = [[This Steel pickaxe is used for advanced mining.
You need:
50 Steel
10 Wood
]]
...
GMS.RegisterCombi("Steel_Pickaxe",COMBI,"AdvancedWeapons")
...
COMBI.Description = [[This Diamond pickaxe is used for advanced mining.
You need:
50 Diamond
10 Wood
]]
...
COMBI.Req["Wood"] = 100
COMBI.Texture = "weapons/swep"
COMBI.SwepClass = "gms_Diamondfishingrod"

GMS.RegisterCombi("Diamond_FishingRod",COMBI,"AdvancedWeapons")

/*---------------------------------------------------------
	RefinedDiamond Pickaxe
---------------------------------------------------------*/
local COMBI = {}

COMBI.Name = "Refined Diamond Pickaxe"
COMBI.Description = [[This Diamond pickaxe has be refined and is UBER!
You need:
10 Refined Diamond
...
COMBI.Req = {}
COMBI.Req["Refined_Diamond"] = 10
COMBI.Texture = "weapons/swep"
COMBI.SwepClass = "gms_refined_diamondpickaxe"

GMS.RegisterCombi("RefinedDiamond_Pickaxe",COMBI,"AdvancedWeapons")

/*---------------------------------------------------------
	Refinedhatchet Pickaxe
---------------------------------------------------------*/
local COMBI = {}

COMBI.Name = "Refined Diamond Hatchet"
COMBI.Description = [[This Diamond hatchet has be refined and is UBER!
You need:
10 Refined Diamond
...
COMBI.Req["Refined_Diamond"] = 10
COMBI.Texture = "weapons/swep"
COMBI.SwepClass = "gms_refined_diamondhatchet"

GMS.RegisterCombi("RefinedDiamond_Hatchet",COMBI,"AdvancedWeapons")
...
COMBI.Texture = "weapons/swep"
COMBI.SwepClass = "gms_steelfryingpan"
...
COMBI.Description = [[Uses steam power to clone resources.
You need:
500 Wood
500 Iron
500 Water_Bottles
...
COMBI.Name = "TROPHY: Quarter Process Time"
COMBI.Description = [[All processes take a quarter of the time.
PERMENENT UPGRADE ONLY BUILD THIS ONCE
WARNING MUST BE OVER OR ON LEVEL 200 TO GET ACHIEVMENT!
You need:
100 Refined Diamond
1000 Wood
1000 Iron
...
COMBI.Req = {}
COMBI.Req["Refined_Diamond"] = 100
COMBI.Req["Wood"] = 1000
COMBI.Req["Iron"] = 1000
COMBI.Req["Copper"] = 1000
COMBI.Req["Steel"] = 500
COMBI.Req["Herbs"] = 100

COMBI.Results = {}
COMBI.Results = "gms_trophy_quarterspeed"
COMBI.BuildSiteModel = "models/props_c17/pottery06a.mdl"

GMS.RegisterCombi("TROPHY-QuarterProcessTime",COMBI,"Trophys")
...
COMBI.Name = "TROPHY: Instant Plant"
COMBI.Description = [[Instantly plant plants.
PERMENENT UPGRADE ONLY BUILD THIS ONCE
WARNING MUST BE OVER OR ON LEVEL 75 TO GET ACHIEVMENT!
You need:
1000 Water_Bottles
1000 Urine_Bottles
1000 Orange_Seeds
...
COMBI.Req = {}
COMBI.Req["Water_Bottles"] = 1000
COMBI.Req["Urine_Bottles"] = 1000
COMBI.Req["Melon_Seeds"] = 1000
COMBI.Req["Orange_Seeds"] = 1000
COMBI.Req["Banana_Seeds"] = 1000
COMBI.Req["Herbs"] = 1000


COMBI.Results = {}
COMBI.Results = "gms_trophy_instantplant"
COMBI.BuildSiteModel = "models/props_c17/pottery06a.mdl"

GMS.RegisterCombi("TROPHY-InstantPlant",COMBI,"Trophys")
...
COMBI.Name = "TROPHY: Wild Man"
COMBI.Description = [[Decreases hunger,thirst and sleep decrease amount.
PERMENENT UPGRADE ONLY BUILD THIS ONCE
WARNING MUST BE OVER OR ON LEVEL 250 TO GET ACHIEVMENT!
You need:
10000 Water_Bottles
5000 Urine_Bottles
5000 Steel
...
5000 Wood
5000 Iron
200 Refined_Diamonds
]]

COMBI.Req = {}
COMBI.Req["Steel"] = 5000
COMBI.Req["Iron"] = 5000
COMBI.Req["Copper"] = 5000
COMBI.Req["Wood"] = 5000
COMBI.Req["Refined_Diamond"] = 200
COMBI.Req["Water_Bottles"] = 10000
COMBI.Req["Urine_Bottles"] = 5000


COMBI.Results = {}
COMBI.Results = "gms_trophy_wildman"
COMBI.BuildSiteModel = "models/props_c17/pottery06a.mdl"

GMS.RegisterCombi("TROPHY-WildMan",COMBI,"Trophys")
...
COMBI.Name = "TROPHY: Mr Survival"
COMBI.Description = [[Decreases hunger,thirst and sleep decrease amount drasticly.
PERMENENT UPGRADE ONLY BUILD THIS ONCE
WARNING MUST BE OVER OR ON LEVEL 300 TO GET ACHIEVMENT!
You need:
50000 Water_Bottles
10000 Urine_Bottles
5000 Steel
...
25000 Wood
25000 Iron
300 Refined_Diamonds
]]

COMBI.Req = {}
COMBI.Req["Steel"] = 5000
COMBI.Req["Iron"] = 25000
COMBI.Req["Copper"] = 25000
COMBI.Req["Wood"] = 25000
COMBI.Req["Refined_Diamond"] = 300
COMBI.Req["Water_Bottles"] = 50000
COMBI.Req["Urine_Bottles"] = 10000


COMBI.Results = {}
COMBI.Results = "gms_trophy_mrsurvival"
COMBI.BuildSiteModel = "models/props_c17/pottery06a.mdl"

GMS.RegisterCombi("TROPHY-MrSurvival",COMBI,"Trophys")
...
COMBI.Name = "TROPHY: Time Waster"
COMBI.Description = [[Make this if you are bored.
PERMENENT UPGRADE ONLY BUILD THIS ONCE
You need:
100000 Water_Bottles
100000 Urine_Bottles
10000 Steel
100000 Copper
100000 Wood
100000 Iron
500 Refined_Diamonds
]]

COMBI.Req = {}
COMBI.Req["Steel"] = 10000
COMBI.Req["Iron"] = 100000
COMBI.Req["Copper"] = 100000
COMBI.Req["Wood"] = 100000
COMBI.Req["Refined_Diamond"] = 500
COMBI.Req["Water_Bottles"] = 100000
COMBI.Req["Urine_Bottles"] = 100000


COMBI.Results = {}
COMBI.Results = "gms_trophy_timewaster"
COMBI.BuildSiteModel = "models/props_c17/pottery06a.mdl"

GMS.RegisterCombi("TROPHY-Time Waster",COMBI,"Trophys")
...
COMBI.Name = "TROPHY: Flying_Man"
--Allows the player to fly to move around the map quicker.
COMBI.Description = [[WARNING THIS IS DISABLED! BUILD ONLY FOR E-PENIS
PERMENENT UPGRADE ONLY BUILD THIS ONCE
USE GMS_NOCLIP TO TOGGLE FLIGHT
You need:
250 Refined_Diamonds
]]

COMBI.Req = {}
COMBI.Req["Refined_Diamond"] = 250


COMBI.Results = {}
COMBI.Results = "gms_trophy_noclip"
COMBI.BuildSiteModel = "models/props_c17/pottery06a.mdl"

GMS.RegisterCombi("TROPHY-Flying_Man",COMBI,"Trophys")
...
COMBI.Name = "TROPHY: Half Process Time"
COMBI.Description = [[All processes take half the time.
PERMENENT UPGRADE ONLY BUILD THIS ONCE
You need:
50 Refined Diamond
500 Wood
...
COMBI.Req = {}
COMBI.Req["Refined_Diamond"] = 50
COMBI.Req["Wood"] = 500
COMBI.Req["Iron"] = 500
COMBI.Req["Copper"] = 500
COMBI.Req["Steel"] = 250
COMBI.Req["Herbs"] = 50

COMBI.Results = {}
COMBI.Results = "gms_trophy_halfspeed"
COMBI.BuildSiteModel = "models/props_c17/pottery06a.mdl"

GMS.RegisterCombi("TROPHY-HalfProcessTime",COMBI,"Trophys")
...
COMBI.Name = "TROPHY: Half Price Props"
COMBI.Description = [[All processes take half the time.
PERMENENT UPGRADE ONLY BUILD THIS ONCE
You need:
10 Refined Diamond
...
COMBI.Results = {}
COMBI.Results = "gms_trophy_halfpriceprops"
COMBI.BuildSiteModel = "models/props_c17/pottery06a.mdl"

GMS.RegisterCombi("TROPHY-HalfPriceProps",COMBI,"Trophys")
...
COMBI.Name = "TROPHY: Stone Age"
COMBI.Description = [[Gives players tools on spawn.
Level 100 survival required.
PERMENENT UPGRADE ONLY BUILD THIS ONCE
You need:
50 Refined Diamond
2000 Stone
...
COMBI.Req = {}
COMBI.Req["Stone"] = 2000
COMBI.Req["Wood"] = 2000
COMBI.Req["Refined_Diamond"] = 50

COMBI.Results = {}
COMBI.Results = "gms_trophy_stoneage"
COMBI.BuildSiteModel = "models/props_c17/pottery06a.mdl"

GMS.RegisterCombi("TROPHY-StoneAge",COMBI,"Trophys")
...
COMBI.Name = "TROPHY: Copper Age"
COMBI.Description = [[Gives players tools on spawn.
Level 200 survival required.
PERMENENT UPGRADE ONLY BUILD THIS ONCE
You need:
75 Refined Diamond
4000 Stone
...
COMBI.Req = {}
COMBI.Req["Stone"] = 4000
COMBI.Req["Wood"] = 4000
COMBI.Req["Copper"] = 2000
COMBI.Req["Refined_Diamond"] = 75

COMBI.Results = {}
COMBI.Results =  "gms_trophy_copperage"
COMBI.BuildSiteModel = "models/props_c17/pottery06a.mdl"

GMS.RegisterCombi("TROPHY-CopperAge",COMBI,"Trophys")
...
COMBI.Name = "TROPHY: Iron Age"
COMBI.Description = [[Gives players tools on spawn.
Level 300 survival required.
PERMENENT UPGRADE ONLY BUILD THIS ONCE
You need:
100 Refined Diamond
6000 Stone
...
COMBI.Req = {}
COMBI.Req["Stone"] = 6000
COMBI.Req["Wood"] = 6000
COMBI.Req["Copper"] = 6000
COMBI.Req["Iron"] = 3000
COMBI.Req["Refined_Diamond"] = 100


COMBI.Results = {}
COMBI.Results = "gms_trophy_ironage"
COMBI.BuildSiteModel = "models/props_c17/pottery06a.mdl"

GMS.RegisterCombi("TROPHY-IronAge",COMBI,"Trophys")
...
COMBI.Name = "TROPHY: Mechanic"
COMBI.Description = [[Allows players the ability to build vehicles.
Level 250 survival required.
PERMENENT UPGRADE ONLY BUILD THIS ONCE
You need:
100 Refined Diamond
2500 Steel
...
COMBI.Req = {}
COMBI.Req["Refined_Diamond"] = 100
COMBI.Req["Steel"] = 2500
COMBI.Req["Iron"] = 2500
COMBI.Req["Coal"] = 5000

COMBI.Results = {}
COMBI.Results = "gms_trophy_mechanic"
COMBI.BuildSiteModel = "models/props_c17/pottery06a.mdl"

GMS.RegisterCombi("TROPHY-Mechanic",COMBI,"Trophys")

local COMBI = {}

COMBI.Name = "TROPHY: Mans Best Friend"
COMBI.Description = [[Allows the player to adopt a pet.
PERMENENT UPGRADE ONLY BUILD THIS ONCE
You need:
50 Wood
10 Water_Bottles
...
COMBI.Results = {}
COMBI.Results = "gms_trophy_mansbestfriend"
COMBI.BuildSiteModel = "models/props_c17/pottery06a.mdl"

--GMS.RegisterCombi("TROPHY-MansBestFriend",COMBI,"Trophys")
...
COMBI.Name = "TROPHY: Sprint Man"
COMBI.Description = [[Years of practise and you are getting quicker.
-- This makes you run quicker
PERMENENT UPGRADE ONLY BUILD THIS ONCE
You need:
400 Wood
100 Stone
...
COMBI.Results = {}
COMBI.Results = "gms_trophy_sprintman"
COMBI.BuildSiteModel = "models/props_c17/pottery06a.mdl"

GMS.RegisterCombi("TROPHY-SprintMan",COMBI,"Trophys")
...
COMBI.Name = "TROPHY: Adapted"
COMBI.Description = [[You have learnt to survive better.
--This sets you max health to 200.
-name by Doku , RESPECT (inside joke...)
PERMENENT UPGRADE ONLY BUILD THIS ONCE
You need:
100 Wood
500 Stone
...
COMBI.Req["Wood"] = 100
COMBI.Req["Stone"] = 500
COMBI.Req["Water_Bottles"] = 75

COMBI.Results = {}
COMBI.Results = "gms_trophy_adapted"
COMBI.BuildSiteModel = "models/props_c17/pottery06a.mdl"

GMS.RegisterCombi("TROPHY-Adapted",COMBI,"Trophys")
...
COMBI.Name = "TROPHY: Scientist"
COMBI.Description = [[You always carry you trusted tool gun with you.
PERMENENT UPGRADE ONLY BUILD THIS ONCE
You need:
50 Reinfed Diamond
1000 Urine_Bottles
...
COMBI.Req["Stone"] = 400
COMBI.Req["Wood"] = 300
COMBI.Req["Copper"] = 250
COMBI.Req["Iron"] = 400

COMBI.Results = {}
COMBI.Results = "gms_trophy_scientist"
COMBI.BuildSiteModel = "models/props_c17/pottery06a.mdl"

GMS.RegisterCombi("TROPHY-Scientist",COMBI,"Trophys")
...
COMBI.Name = "TROPHY: Christmas Tree"
COMBI.Description = [[MERRY CHRISTMAS FROM AWOL!
PERMENENT UPGRADE WILL GIVE YOU EXTRA CHRISMAS BASED FEATURES!
SPECIAL: BUILD NOW OR YOU MAY LOSE YOUR CHANCE
WARNING: For some reason it takes a while to make. Just wait!
You need:
250 Wood
10 Glass
10 Iron
...
COMBI.Results = {}
COMBI.Results = "gms_trophy_christmastree"
COMBI.BuildSiteModel = "models/cloud/kn_xmastree.mdl"

--CHRISTMAS TREE DELETE COMMENT TO ENABLE!
//GMS.RegisterCombi("TROPHY-ChristmasTree",COMBI,"Buildings")
...
COMBI.Name = "TROPHY: New Years"
COMBI.Description = [[HAPPY NEW YEARS
PERMENENT UPGRADE WILL GIVE YOU EXTRA NEW YEARS BASED FEATURES!
SPECIAL: BUILD NOW OR YOU MAY LOSE YOUR CHANCE
WARNING: For some reason it takes a while to make. Just wait!
You need:
200 Iron
...
COMBI.Results = {}
COMBI.Results = "gms_trophy_newyears"
COMBI.BuildSiteModel = "models/combine_helicopter/helicopter_bomb01.mdl"

--NEW YEARS DELETE COMMENT TO ENABLE!
//GMS.RegisterCombi("TROPHY-NewYears",COMBI,"Buildings")
...
GMS.RegisterCombi("Christmastree",COMBI,"SpecialBuildings")
...
COMBI.Trophy = "Mr_Survival"
COMBI.Description = [[You read right. Only Mr Survival can make it though.
You need:
50 Watter bottles
5 Urine Bottles
10 Herbs
