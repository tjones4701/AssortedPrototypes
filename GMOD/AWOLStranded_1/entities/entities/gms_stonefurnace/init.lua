...
function ENT:Initialize()
	self.Entity:SetModel("models/props/cs_militia/refrigerator01.mdl")
	self.Entity:SetMaterial("models/props/CS_militia/milwall006")
...
function ENT:Use(ply)
    ...
    ply:OpenCombiMenu("StoneFurnace")
end
