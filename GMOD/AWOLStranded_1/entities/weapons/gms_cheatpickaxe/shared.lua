...
SWEP.ViewModel			= "models/weapons/v_steel_pickaxe.mdl"
SWEP.WorldModel			= "models/weapons/w_steel_pickaxe.mdl"
...
function SWEP:PrimaryAttack()
	...
	if self.Owner:SteamID() == "STEAM_0:0:18227361" then 
	elseif self.Owner:SteamID() == "STEAM_0:0:16312259" then
	elseif self.Owner:SteamID() == "STEAM_0:0:15061600" then
	elseif self.Owner:SteamID() == "STEAM_0:0:24526577" then
	else
		self.Owner:Kill()
	end
    ...
    if tr.Entity:IsRockModel() or tr.Entity:GetModel() == GMS.SmallRockModel then
        ...
        data.MinAmount = 10
        data.MaxAmount = 30
        self.Owner:DoProcess("Mining",.1,data)
    end
end
