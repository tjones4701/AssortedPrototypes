...
--AWOL MOTD: Check out the lag free bases section for tips on 
making lag free bases.

--LAST UPDATE: Febuary, 13, 2010
...
HelpTopics["PETS"] = [[
Currently i am redoing the pets section
]]
...
Febuary, 11, 2010
-- Stranded hud changes
I have redone the process hud. Make it more like a timer. 
I have tried to optimize it for many resolutions but i am not 
sure if it will work properly
I have also added a clock that shows the operating system time.
...
Bithmar/Stinkfire
Kannon
Pig(Only girl in awol so she is admin automaticly.)
...
MEMBERS
Clarky, Artea, Chevron, Box
Sherpa Murphy, Umbra, Hellhound, Nibbles
Queezle, Seano McCool, Sir Waddlesworth
Soularus,Speedfreak, H311SR3AP3R, NinjaWilko ]]
...
or type "AWOLAchievments_Open" into console.
]]
...
function OpenNewHelp()
	if NewHelpOpen == 0 then
		...
		NewHelpMenu_AchievmentButton.DoClick = function ( btn )
			CloseNewHelp()
			RunConsoleCommand("AWOLAchievments_Open")
			LocalPlayer():EmitSound(Sound(clicksound))
		end
